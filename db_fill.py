...
def random_dates():
    ...
    return(res_arr_date, arr_hour_min, res_dep_date, dep_hour_min)
...
def requetes_eleves_demandes(nb_eleves, nb_demandes_simples, nb_demandes_paires):
    ...
    for i in range(nb_demandes_simples):
        ...
        arrival_date, arrival_time, departure_date, departure_time = random_dates()
        mate = 0
        mate_email = "NULL"
        validee = 0
        demande_query="INSERT INTO demande (id_demande, id_eleve, type_chambre, remplace, gender_choice, arrival_date, arrival_time, departure_date, departure_time, mate, mate_email, validee)" \
                      "VALUES (NULL, %d, %d, %d, %d, '%s', '%s', '%s', '%s', %d, %s, %d);"%(id_eleve, type_chambre, remplace, gender_choice, arrival_date, arrival_time, departure_date, departure_time, mate, mate_email, validee)
    ...
    for i in range(nb_demandes_paires):
        ...
        arrival_date, arrival_time, departure_date, departure_time = random_dates()  # On fait une simplification ici...
        mate = 1
        validee = 0

        # La demande de l'eleve 1
        demande_query="INSERT INTO demande (id_demande, id_eleve, type_chambre, remplace, gender_choice, arrival_date, arrival_time, departure_date, departure_time, mate, mate_email, validee)" \
                      "VALUES (NULL, %d, %d, %d, %d, '%s', '%s', '%s', '%s', %d, '%s', %d);"%(id_eleve_1, type_chambre, remplace, genre_eleve_2, arrival_date, arrival_time, departure_date, departure_time, mate, mail_eleve_2, validee)
        liste_queries_demande.append(demande_query)

        # La demande de l'eleve 2
        demande_query = "INSERT INTO demande (id_demande, id_eleve, type_chambre, remplace, gender_choice, arrival_date, arrival_time, departure_date, departure_time, mate, mate_email, validee)" \
                        "VALUES (NULL, %d, %d, %d, %d, '%s', '%s', '%s', '%s', %d, '%s', %d);"%(id_eleve_2, type_chambre, remplace, genre_eleve_1, arrival_date, arrival_time, departure_date,departure_time, mate, mail_eleve_1, validee)
        liste_queries_demande.append(demande_query)
