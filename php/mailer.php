...
function send_mail($email_address, $activation_code, $typemessage) {
    ...
    ';}
    if($typemessage==5){
        $subject = 'Le paiment a bien été effectué';
        $message= '
        <html xmlns="http://www.w3.org/1999/xhtml">
            <head>
                <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
                <title>Le paiment a bien été effectué</title>
                <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
            </head>
            <body style="margin: 0; padding: 0;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%"> 
                                ...
                                <tr>
                                    <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td style="text-align: center; color: #2c2e50; font-family: Arial, sans-serif; font-size: 24px;">
                                                    <b>Ton paiment a bien été pris en compte</b>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: justify; padding: 20px 0 30px 0; color: #2c2e50; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                                    Bonjour,<br/>
                                                    <br/>
                                                    Le club informatique des Ponts confirme que le paiment a bien été effectué <strong>Ta réservation a donc bien été effectué.</strong> Nous t\'attendons donc et te souhaitons bon courage pour tes oraux.<br/><br/>
                                                    Nous t\'invitons à retourner sur le site des admissibles si jamais tu as la moindre question, tu y trouvera le planning de ta semaine ainsi que les contacts du BDE.
                                                <td style="text-align: justify; padding: 20px 0 30px 0; color: #2c2e50; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
