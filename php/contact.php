            ...
            <div class="container">
                ...
                <div class="row justify-content-center" style="margin-bottom:2rem;">
                    <div class="col-lg-8">
                        ...
                        <p class="lead" style="text-align: center"><?php if (isset($_SESSION['loggedin'])){echo '<strong>06 29 19 40 11</strong></br>';}?><strong>admissibles@enpc.org</strong></p>
                    </div>
                </div>
                ...
                <div class="row justify-content-center" style="margin-bottom:2rem;">
                    <div class="col-lg-8">
                        ...
                        <p class="lead" style="text-align: center"><strong>07 68 08 62 64</strong></p>
                    </div>
                </div>';}?>
